const events = [
  ...
  [
    ...
    // IDEA PRESENTATION
    {
      ...
      paragraph:
        "<b>DESCRIPTION :</b><br><b>ROUND 1:</b> Idea Pitching<br><b>ROUND 2:</b> Presentation<br><br><b>JUDGING CRITERIA:</b><br>1. Originality of idea. <br>2. Scalability.<br>3. Feasibility.<br>4. Impact on society.<br>5.  Impact on Environment.<br><br><b>RULES:</b><br>1.  This event is open for all.<br>2. All teams will must participate in round 1 for qualification. <br>3. Name of the participating teams with members names should be submitted before 21st April 11:50 PM<br>4.  In the first round you have to mail your PowerPoint Presentation on the email id mentioned below.<br>5. Teams unable to follow the guidelines will be disqualified.<br>6. The selected teams will perform Round 2 Presentation (10 - 15 min). <br>7. The decision of the Technical Board will be final and no queries will be entertained.<br> 8. All teams will send Presentations at: <a class='mail_link' href='mailto:ait.solutions2k23@gmail.com'>ait.solutions2k23@gmail.com</a> <br>9. Round 2 will be conducted on Microsoft Teams.<br>10. PowerPoint Presentation name should be in the format TeamName_TopicName.",
      descriptionDown: "",
    },
    // PHOTOGRAPHY
    {
